...
link_videos = Vimeo('LINK_DO_VIMEO', embedded_on='URL_DA_PÁGINA_ONDE_O_VÍDEO_ESTÁ_INCORPORADO')
...
'''
Obs: substitua 'LINK_DO_VIMEO' pelo link do vimeo que deseja baixar, e substitua 'URL_DA_PÁGINA_ONDE_O_VÍDEO_ESTÁ_INCORPORADO' pela URL real da página onde o vídeo está incorporado.
